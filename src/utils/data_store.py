...
class OrderDataStore:
            ...
            results.append(
                (
                    ...
                    product.product_id,
                    {
                        ...
                        "note": "Chọn product_id và gọi get_product_details để xác nhận giá, tồn kho và detail_token.",
                    },
                )
            )
    ...
    def save_order(
        ...
        *,
        ...
        if pricing_snapshot.get("status") != "ok":
        ...
        payload = {
            ...
            "notes": notes.strip(),
            "save_path": str(relative_path.as_posix()),
